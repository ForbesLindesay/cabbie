...
Browser.prototype._request = function (method, path, body) {
  return this._connection.sessionRequest(this._session(), method, path, body);
};
 ...
 * @returns {Session}
 */
Browser.prototype._session = function () {
 ...
 * @returns {Session}
 */
Browser.prototype.session = Browser.prototype._session;
 ...
 * @return {boolean}
 */
Browser.prototype.hasElement = function (selector, selectorType) {
