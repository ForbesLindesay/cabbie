 ...
 * @returns an array of cookie json objects (@see https://code.google.com/p/selenium/wiki/JsonWireProtocol#Cookie_JSON_Object)
 */
 ...
 * @returns a cookie json object or null (@see https://code.google.com/p/selenium/wiki/JsonWireProtocol#Cookie_JSON_Object)
 */
...
/**
 * Sets a cookie.
 * @param {Object} cookie - a cookie json object, @see https://code.google.com/p/selenium/wiki/JsonWireProtocol#Cookie_JSON_Object
 */
Browser.prototype.setCookie = function (cookie) {
  type('cookie', cookie, 'Object');
  type('cookie.name', cookie.path, 'String');
  type('cookie.value', cookie.path, 'String');

  cookie.path = cookie.path || '/';
  cookie.domain = cookie.domain || url.parse(this.getUrl()).hostname;
