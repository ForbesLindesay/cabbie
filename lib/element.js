...
Element.prototype._request = function (method, path, body) {
  return this._browser._request(method, '/element/' + this._id.ELEMENT + path, body);
};
Element.prototype._requestJSON = function (method, path, body) {
  return this._browser._requestJSON(method, '/element/' + this._id.ELEMENT + path, body);
};
 ...
 * @returns {Object}
 */
Element.prototype.getElementHandler = function () {
  return this._id;
};
