...
export type TimeOutsConfig = {[key in TimeOutTypes]?: TimeoutValue};
...
class TimeOut extends BaseClass {
  ...
  async setScriptTimeOut(timeout: TimeoutValue): Promise<void> {
    ...
    await this.requestJSON('POST', '', {
      type: TimeOutTypes.SCRIPT,
      ms: timeout,
    });
  }
